<template>
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="mb-8 bg-white px-6 py-4 rounded-lg shadow-sm flex flex-col gap-4">
            <!-- Search Bar -->
            <div class="relative">
            ...
            <div class="row-span-3 flex items-center gap-2">
                ...
                <div class="flex items-center gap-2">
                    <button
                        ...
                        :key="filter"
                        @click="selectedFilter = filter; if (filter === 'All') selectedSubFilter = 'All'"
                        :class="[
            ...
            <div v-if="currentSubFilters.length > 0" class="flex items-center gap-2">  
                <button
                ...
                :class="[
                    ...
                    (selectedSubFilter as string).toLowerCase() === 
                        filter
                         .toLowerCase()
                         .normalize('NFD')                  // Code provided by ChatGPT
                         .replace(/[\u0300-\u036f]/g, ''    // Code provided by ChatGPT
                    )
                    ? 'bg-blue-900 text-white shadow-md' 
                    : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
